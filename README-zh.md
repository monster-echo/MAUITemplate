...
<div style="display: flex; flex-direction: row; gap: 16px;">
  <img src="docs/screenshots/readme-invoke1.png" alt="通用交互中心" width="250" />
  <img src="docs/screenshots/readme-invoke2.png" alt="二进制流式数据演示" width="250" />
</div>
...
_注意：构建完成的前端产物会自动按需复制到 MAUI 的静态资源目录下。_
